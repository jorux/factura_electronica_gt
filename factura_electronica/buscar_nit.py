...
def buscar_nombre (doc, method):
    ...
    if doc.es_dpi == False and doc.es_pasaporte == False:
        try:
            ...
            with urllib.request.urlopen(req) as response:
                ...
                if response_json and 'nombre' in response_json:
                    ...
                    frappe.db.set_value(doc.doctype,{"name":doc.name},{"nombre_segun_sat":nombre})
                    frappe.db.set_value(doc.doctype,{"name":doc.name},{"customer_name":nombre})
                else:
        ...
        frappe.db.set_value(doc.doctype,{"name":doc.name},{"customer_name":doc.customer_name})